...
namespace OmegaWarhead.Core
{
    ...
    public enum NukeState
    {
        ...
        /// <summary>Confirming: activated once, waiting for a second activation within Config.ConfirmWindowSeconds.</summary>
        Confirming,
    ...
    public sealed class NukeSession
    {
        ...
        /// <summary>
        /// Snapshot of total countdown duration (from Config.CountdownTotalSeconds).
        ...
        /// <summary>
        /// Whether the point of no return has been crossed (RemainingTime &lt;= Config.PointOfNoReturnSeconds).
