...
namespace OmegaWarhead
{
    ...
    public sealed class OmegaWarheadPlugin : Plugin<Config>
    {
        ...
        /// <summary>
        /// Global singleton. Subsystems access shared state through this instance,
        ...
        public override void OnEnabled()
        {
            ...
            Log.Info("This plugin is licensed under GPLv3 and is the original work of DNT_OF. " +
                     "Reselling or redistributing modified copies is prohibited. " +
                     "Official source: https://github.com/DNTOF/OmegaWarhead");

            // 0. Initialize translations (Config.Lang), load stats, check for updates
        ...
        private void OnRoundStarted()
        {
            ...
            SpawnPointSelector?.StartSpawnLoop(
                ...
                Constants.MaxSpawnedElements,
                Constants.ElementRespawnDelay);
        }
        ...
        private void OnElementCountChanged(Player player, int count)
        {
            ...
            if (count > 0)
            {
                ...
                TrackingBroadcaster?.StartCollectingBroadcast(player, Constants.CollectingTrackIntervalSeconds);
            }
            else
            {
            ...
            if (count < Constants.RequiredElementCount)
                return;
            ...
            if (!given)
            {
                ...
                player.Broadcast(5, Localization.BroadcastSynthesisFailed);
            }
            else
            {
                player.Broadcast(5, Localization.BroadcastControllerAssembled);
                Exiled.API.Features.Cassie.Message(Localization.CassieComponentAssembled, false, false, true);
            }
        }
