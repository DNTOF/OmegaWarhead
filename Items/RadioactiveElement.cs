...
namespace OmegaWarhead.Items
{
    ...
    /// Holding it deals damage-per-element-per-second. Once Constants.RequiredElementCount
    ...
    public class RadioactiveElement : CustomItem
    {
        ...
        public override string Name { get; set; } = Localization.ItemElementName;

        public override string Description { get; set; } = Localization.ItemElementDesc;
        ...
        /// <summary>
        /// Damage ticker: deals damage once per second = held count * Constants.DamagePerElementPerSecond.
        ...
        private IEnumerator<float> DamageTicker()
        {
            while (true)
            {
                ...
                float perElement = Constants.DamagePerElementPerSecond;
                ...
                foreach (Player player in holders)
                {
                    ...
                    if (damage > 0f)
                        player.Hurt(damage, Localization.KillReasonRadiation);
